...
export const metadata: Metadata = {
  ...
  // og:image, twitter:image는 src/app/opengraph-image.tsx + twitter-image.tsx
  // 가 자동 라우팅 — 여기서 images를 명시하지 않음 (수동 명시 시 자동 라우트와
  // 충돌해서 404 og-image.png가 카톡 캐시에 박힐 수 있음).
  openGraph: {
    title: "김해나 1:1 프리미엄 영어 | 9년차 비즈니스 영어 1위 강사",
    description:
